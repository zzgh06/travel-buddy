    ...
    <div className="max-w-2xl mx-auto mt-4 p-8 bg-white">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <button
          ...
          className={`w-full py-3 rounded-md transition duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 ${createTravelPlan.isPending
